 ...
 * @author mzechner */
//This was a fixed class of some error I had
public class MultiGestureDetector extends InputAdapter {
     ...
     * maxFlingDelay=0.15f. */
    public MultiGestureDetector (GestureListener listener) {
    ...
    public MultiGestureDetector (float halfTapSquareSize, float tapCountInterval, float longPressDuration, float maxFlingDelay,
    ...
    /** Register an instance of this class with a {@link MultiGestureDetector} to receive gestures such as taps, long presses, flings,
    ...
    public static interface GestureListener {
         ...
         * time of the {@link MultiGestureDetector}.
