...
public class AudioDevicePlayer2 extends AudioDevicePlayer {
	...
	public AudioInputStream2 currentStream;
		...
		public void run() {
			...
			try {
				while (!toStop) {
					...
					if (setNextPosition) {
						nextSamplePos = (int) (nextPosition * sampleRate) * channels;
	...
	public boolean getEnd() {return stop;}
	...
	public String getRate(){
		return currentStream.feed();
	}

	public Header getHeader(){
		return currentStream.getHeader();
	}

	public Decoder getDecoder(){
		return currentStream.getDecoder();
	}

	public Bitstream getBitStream() {return currentStream.getBitStream(); }
