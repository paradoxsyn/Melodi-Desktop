 ...
 * @author kevin
 */
public class OggInputStream2 extends AudioInputStream2 {
	 ...
	 */
	public OggInputStream2(InputStream input) throws IOException {
		this.input = input;
	...
	@Override
	public String feed() {return null;}
	...
	@Override
	public Bitstream getBitStream() {return null;}

	@Override
	public int fullFeed() {return -1;}
